  ...
  return (
    <section className="min-h-0 overflow-auto p-4">
      <div className="flex h-full flex-col gap-4">
        ...
        <div className="flex min-h-0 flex-1 flex-col overflow-auto rounded-2xl border border-stone-800 bg-stone-950/60 p-4">
          ...
          {activeMachineId === "root" ? (
            <RootDetail
              ...
              pattern={song.root.patterns[currentScene.machines.root.variation]}
