...
import { getMelodyNoteLabel, MELODY_BASE_NOTE, MELODY_ROW_COUNT } from "../../music";
    ...
    <div className="space-y-4">
      ...
      <PianoRoll
        ...
        rowLabels={Array.from({ length: MELODY_ROW_COUNT }, (_, rowIndex) =>
          getMelodyNoteLabel(MELODY_BASE_NOTE + (MELODY_ROW_COUNT - rowIndex - 1)),
        )}
        rowValues={Array.from(
          { length: MELODY_ROW_COUNT },
          (_, rowIndex) => MELODY_BASE_NOTE + (MELODY_ROW_COUNT - rowIndex - 1),
        )}
        stepCount={64}
      />
